...
function UserLogin() {
  ...
  const kakaoURL = `http://kauth.kakao.com/oauth/authorize?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&response_type=code`

  const kakaoLogin = async () => {
    window.location.href = kakaoURL;
  }

  const githubURL = "https://github.com/login/oauth/authorize?client_id=Iv23lica8LFNbzOrB595";
